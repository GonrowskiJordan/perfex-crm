    ...
    <div class="tw-flex">
        <div class="tw-mr-4 tw-flex-shrink-0 tw-relative">
            <?php if (isset($contact)) { ?>
                <img src="<?= e(contact_profile_image_url($contact->id, 'small')); ?>" id="contact-img" class="client-profile-image-small">

                <?php if (! empty($contact->profile_image)) { ?>
                    <a href="#" onclick="delete_contact_profile_image(<?= e($contact->id); ?>); return false;" class="tw-bg-neutral-500/30 tw-text-neutral-600 hover:tw-text-neutral-500 tw-h-8 tw-w-8 tw-inline-flex tw-items-center tw-justify-center tw-rounded-full tw-absolute tw-inset-0" id="contact-remove-img"><i class="fa fa-remove tw-mt-1"></i></a>
                <?php } ?>
            <?php } ?>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group contact-direction-option">
                <label for="customer_id"><?= _l('client'); ?></label>
                <select class="selectpicker" data-width="100%" name="customer_id" id="customer_id">
                    <?php foreach ($customers as $customer) { ?>
                        <option value="<?= $customer['userid'] ?>" <?= (isset($contact) && $contact->userid == $customer['userid']) ? 'selected' : ''; ?>>
                            <?= $customer['company'] ?>
                        </option>
                    <?php } ?>
                </select>
            ...
            <div id="contact-profile-image" class="form-group<?= (isset($contact) && ! empty($contact->profile_image)) ? ' hide' : ''; ?>">
                <label for="profile_image" class="profile-image"><?= _l('client_profile_image'); ?></label>
            ...
            <?php if (isset($contact)) { ?>
                <div class="alert alert-warning hide" role="alert" id="contact_proposal_warning">
                    ...
                    <a href="#" id="contact_update_proposals_emails" class="alert-link" data-original-email="" onclick="update_all_proposal_emails_linked_to_contact(<?= e($contact->id); ?>); return false;">
            ...
            <div class="form-group contact-direction-option">
                ...
                <select class="selectpicker" data-none-selected-text="<?= _l('system_default_string'); ?>" data-width="100%" name="direction" id="direction">
                    <option value="" <?= (isset($contact) && empty($contact->direction)) ? 'selected' : ''; ?>></option>
            ...
            <div class="client_password_set_wrapper">
                ...
                <?php if (isset($contact)) { ?>
                    ...
                    <?php if ($contact->last_password_change != null) { ?>
                        ...
                        <span class="text-has-action" data-toggle="tooltip" data-title="<?= e(_dt($contact->last_password_change)); ?>">
            ...
            <div class="checkbox">
                <input type="checkbox" name="is_primary" id="contact_primary" <?= ((! isset($contact) && total_rows(db_prefix() . 'contacts', ['is_primary' => 1, 'userid' => $customer_id]) == 0) || (isset($contact) && $contact->is_primary == 1)) ? 'checked' : ''; ?><?= ((isset($contact) && total_rows(db_prefix() . 'contacts', ['is_primary' => 1, 'userid' => $customer_id]) == 1 && $contact->is_primary == 1)) ? ' disabled' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="<?= e($permission['id']); ?>" class="onoffswitch-checkbox" <?= (isset($contact) && has_contact_permission($permission['short_name'], $contact->id) || is_array($default_contact_permissions) && in_array($permission['id'], $default_contact_permissions)) ? 'checked' : ''; ?> value="<?= e($permission['id']); ?>" name="permissions[]">
                                <label class="onoffswitch-label" for="<?= e($permission['id']); ?>"></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="contact_email_notifications">
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="invoice_emails" data-perm-id="1" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->invoice_emails == '1') ? 'checked' : ''; ?> value="invoice_emails" name="invoice_emails">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="estimate_emails" data-perm-id="2" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->estimate_emails == '1') ? 'checked' : ''; ?> value="estimate_emails" name="estimate_emails">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="credit_note_emails" data-perm-id="1" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->credit_note_emails == '1') ? 'checked' : ''; ?> value="credit_note_emails" name="credit_note_emails">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="project_emails" data-perm-id="6" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->project_emails == '1') ? 'checked' : ''; ?> value="project_emails" name="project_emails">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="ticket_emails" data-perm-id="5" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->ticket_emails == '1') ? 'checked' : ''; ?> value="ticket_emails" name="ticket_emails">
                                <label class="onoffswitch-label" for="ticket_emails"></label>
                            </div>
                        </div>
                        <div class="col-md-6 mtop10 border-right">
                            <span>
                                <i class="fa-regular fa-circle-question" data-toggle="tooltip" data-title="<?= _l('only_project_tasks'); ?>"></i>
                                <?= _l('task'); ?>
                            </span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="task_emails" data-perm-id="6" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->task_emails == '1') ? 'checked' : ''; ?> value="task_emails" name="task_emails">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                                <input type="checkbox" id="contract_emails" data-perm-id="3" class="onoffswitch-checkbox" <?= (isset($contact) && $contact->contract_emails == '1') ? 'checked' : ''; ?> value="contract_emails" name="contract_emails">
...
<div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary" data-loading-text="<?= _l('wait_text'); ?>"  autocomplete="off" data-form="#contact-form"><?= _l('submit'); ?></button>
</div>
