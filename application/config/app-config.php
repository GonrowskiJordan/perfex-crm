...
*
*/
define('APP_BASE_URL', 'https://ionel.themesic.com/');
...
*/
define('APP_ENC_KEY', '81d7648e76bdba6557535b710e7f95ec');
 ...
 */
define('APP_DB_USERNAME', 'ionel_main');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'R3gy6mYBKh4VBm3CZWNZ');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'ionel_main');
